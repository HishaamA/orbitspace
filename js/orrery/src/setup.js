...
export let pathMaterials = [
    new THREE.LineBasicMaterial({ color: 0xFAFAFA, linewidth: 2, transparent:true, opacity: 0.5 }),
    new THREE.LineBasicMaterial({ color: 0xFAFAFA, linewidth: 2, transparent:true, opacity: 0.35 }),
    new THREE.LineBasicMaterial({ color: 0xFAFAFA, linewidth: 2, transparent:true, opacity: 0.3 }),
    new THREE.LineBasicMaterial({ color: 0xFAFAFA, linewidth: 2, transparent:true, opacity: 0.25 }),
    new THREE.LineBasicMaterial({ color: 0xFAFAFA, linewidth: 2, transparent:true, opacity: 0.2 })
];
...
const ambient = new THREE.AmbientLight( 0x505060 );
...
// make sun
const sunGeometry = new THREE.SphereGeometry( 0.1, 42, 42 );
